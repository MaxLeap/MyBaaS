...
public class ObjectId implements Comparable<ObjectId>, java.io.Serializable {
     ...
     *
     * @see com.maxleap.domain.base.ObjectId#createFromLegacyFormat(int, int, int)
     ...
     * {@link com.maxleap.domain.base.ObjectId#createFromLegacyFormat(int, int, int)} instead.
     */
    @Deprecated
    ...
    public ObjectId(String s, boolean babble) {
        ...
        if (!isValid(s))
            throw new LASException(LASException.INVALID_OBJECT_ID, "invalid ObjectId [" + s + "]");
    ...
    public ObjectId(byte[] b) {
        if (b.length != 12)
            throw new RuntimeException("need 12 bytes");
        ByteBuffer bb = ByteBuffer.wrap(b);
        _time = bb.getInt();
        _machine = bb.getInt();
        _inc = bb.getInt();
    ...
    public static String babbleToMongod(String b) {
        if (!isValid(b))
            throw new RuntimeException("invalid object id: " + b);
    ...
    public static void validate(String msg, String s) {
        if (!isValid(s)) {
            if (msg != null) {
                throw new RuntimeException(msg + " invalid ObjectId [" + s + "]");
            }
            throw new RuntimeException("invalid ObjectId [" + s + "]");
        }
    }
