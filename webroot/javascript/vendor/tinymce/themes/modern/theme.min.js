tinymce.ThemeManager.add("modern", function (a) {
    function b() {
        function b(b) {
            ...
            if (b)return l(b.split(/[ ,]/), function (b) {
                ...
                var f;
                "|" == b ? d = null : k.has(b) ? (b = {type: b}, j.toolbar_items_size && (b.size = j.toolbar_items_size), e.push(b), d = null) : (d || (d = {
                    type: "buttongroup",
                    items: []
    ...
    function c() {
        ...
        var d, e = [], f = [];
        if (j.menu)for (d in j.menu)f.push(d); else for (d in n)f.push(d);
