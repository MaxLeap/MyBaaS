...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        var w = document, _ = Array.prototype.push, E = Array.prototype.slice, k = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, N = e.Event, S, T = r.makeMap("fillOpacity fontWeight lineHeight opacity orphans widows zIndex zoom", " "), R = r.makeMap("checked compact declare defer disabled ismap multiple nohref noshade nowrap readonly selected", " "), A = {
            "for": "htmlFor",
            "class": "className",
            readonly: "readOnly"
        }, B = {"float": "cssFloat"}, D = {}, H = {}, M = /^\s*|\s*$/g;
        return f.fn = f.prototype = {
            constructor: f, selector: "", context: null, length: 0, init: function (e, t) {
                ...
                if (a(e)) {
                    if (n.selector = e, r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : k.exec(e), !r)return f(t).find(e);
    ...
    }), r(R, [y, N, g, T, _, E, u, d], function (e, t, n, r, i, o, a, s) {
    ...
    }), r(M, [h, A, D, x, H, u, d], function (e, n, r, i, o, a, s) {
        function l(e, t, i, a) {
            var s = this;
        ...
        var n = e.each;
        return {getCssText: t}
    }), r(O, [h, x, H, L, d, P], function (e, t, n, r, i, o) {
        return function (a) {
            function s(e) {
    ...
    }), r(W, [T, u, d, L, x, h], function (e, n, r, i, o, a) {
    ...
    }), r(J, [K, j, q, X, G, d, Y], function (e, t, n, r, i, o, a) {
        var s = {};
        return e.extend({
    ...
    }), r(dt, [y, f, C, w, _, R, T, M, O, I, F, z, W, V, b, l, at, E, N, st, u, d, ct, ut], function (e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, E) {
        function k(e, t, i) {
            var o = this, a, s;
    ...
    }), r($t, [K, kt, rt, d, ht, u], function (e, t, n, r, i, o) {
        function a(e) {
            function t(t, n) {
                return function () {
                    var r = this;
