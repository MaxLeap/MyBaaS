        ...
        return function (c) {
            ...
            function h() {
                c.on("KeyDown SetContent VisualAid", function () {
                    ...
                    a && "TABLE" == a.nodeName && (c.settings.forced_root_block ? c.dom.add(c.getBody(), c.settings.forced_root_block, c.settings.forced_root_block_attrs, b.ie && b.ie < 11 ? "&nbsp;" : '<br data-mce-bogus="1" />') : c.dom.add(c.getBody(), "br", {"data-mce-bogus": "1"}))
            ...
            n.tableProps = function () {
                ...
                e === !0 ? (n = s.getParent(d.selection.getStart(), "table"), n && (t = {
                    ...
                    items: [{
                        ...
                        items: [o, p, {label: "Width", name: "width"}, {
                            label: "Height",
                            name: "height"
                    ...
                    data: t,
                    bodyType: "tabpanel",
                    body: [{title: "General", type: "form", items: r}, f(s)],
                    onsubmit: j
                })) : d.windowManager.open({title: "Table properties", data: t, body: r, onsubmit: j})
